...
<body>
    ...
    <div class="row align-items-md-stretch text-center">
      ...
      <div class="col-md-4">
      	<div class="h-100 p-2">
      		<!-- 웹 앱 내부 접근 시 -->
<%--       		<img alt="도서이미지" src="./resources/images/<%= book.getFilename() %>" style="width:250px; hight: 350px"> --%>
					<!-- 외부 폴더 접근 시 -->
					<img alt="도서이미지" src="<%= request.getContextPath() %>/images/<%= book.getFilename() %>" style="width:250px; hight: 350px">
